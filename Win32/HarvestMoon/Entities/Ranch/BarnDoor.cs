...
namespace HarvestMoon.Entities.Ranch
{
    public class BarnDoor: Door
    {
        ...
        public BarnDoor(ContentManager content, Vector2 initialPosition, Size2 doorSize): base(initialPosition, doorSize)
        {
            _triggered = false;
        ...
        {
            spriteBatch.Draw(_sprite, Position, 0, new Vector2(1, 1.03f));
