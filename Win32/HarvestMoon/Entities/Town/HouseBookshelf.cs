...
namespace HarvestMoon.Entities.Town
{
    internal class HouseBookshelf: Bookshelf
    {
        ...
        {
            return new List<string> { "Hoe", "Sickle", "Hammer", "Axe", "Watering can", "Seeds", "Milker" };
        }
        ...
        static List<string> GetText()
        {
            return new List<string> {
                ...
                "This tool is used to break stones, required for mining. To break big stones you have to focus in-place without input and hit six.",
                ...
                "When a cow has high affection it will start producing milk. To use the milker you have to step next to a cow and press the action button. Do note that cows can be milked on a daily basis."
